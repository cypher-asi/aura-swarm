...
The `aura-swarm-auth` crate provides authentication integration with zOS (`zosapi.zero.tech`). For v0.1.0, we use email/password authentication with JWT tokens validated locally via JWKS.
